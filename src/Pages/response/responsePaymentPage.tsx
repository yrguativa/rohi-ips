...
export default function ResponsePaymentPage() {
    ...
    useEffect(() => {
        dispatch(thunkPaymentApply(idPayment));
    }, [dispatch, StatusAuth, idPayment]);
        ...
        <div className="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
            ...
            <div
                ...
                <div className="flex flex-col gap-7.5">
                    {statusResponse === STATUS_RESPONSE_SUCCESS && status === "approved" && (
                        <div
                            ...
                            <div className="w-full">
                                ...
                                <p className="text-base leading-relaxed text-body">
                                    Hemos recibido su pago y podra continuar con los servicios activos<br></br>
                                    <NavLink className='inline-flex items-center justify-center rounded-md mt-5 bg-black py-4 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-10'
                                        to="/">
                                        Regresar
                                    </NavLink>
                                </p>
                    ...
                    {(statusResponse === STATUS_RESPONSE_PENDING || statusResponse === STATUS_RESPONSE_SUCCESS && status !== "approved") && (
                        <div
                    ...
                    {statusResponse === STATUS_RESPONSE_FAILURE && (
                        <div
                            ...
                            <div className="w-full">
                                ...
                                <ul>
                                    <li className="leading-relaxed text-[#CD5D5D]">
                                        No se completo el proceso de pago por algun error
                                    </li>
                                </ul>
                            </div>
                        </div>
