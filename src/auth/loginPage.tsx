                                ...
                                <div className="hidden w-full xl:block xl:w-1/2">
                                    <div className="py-17.5 px-26 text-center">
                                        ...
                                        <p className="font-medium 2xl:px-20">
                                            Plataforma integral para gestion de los servivios de Home Rohi.
                                        </p>
                                        ...
                                        <form onSubmit={handleSubmit(onSubmit)}>
                                            <div className="mb-4">
                                                ...
                                                <div className="relative">
                                                    <input id="email" type="text" placeholder="Email" className={"w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                                                    ...
                                                    {
                                                        errors.email && <p className="text-[#B45454] text-xs italic">{errors.email.message}</p>
                                                    }
                                                </div>
                                            </div>
                                            <div className="mb-6">
                                                ...
                                                <div className="relative">
                                                    <input id="password" type="password" placeholder="******************" className={"w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary "
                                                    ...
                                                    {
                                                        errors.password && <span className="text-[#B45454] text-xs italic">{errors.password.message}</span>
                                                    }
                                                </div>
                                            </div>
