...
import { IUserRegisterAuth } from "../models/interfaces";
import { thunkRegister } from "../store/slices/auth";
...
export default function RegisterPage() {
    ...
    const onSubmit = (data: RegisterForm) => {
        const registerUser: IUserRegisterAuth = { 
            email : data.Email,
            password: data.Password,
            displayName : data.UserName
        };
        dispatch(thunkRegister(registerUser));
    }
                                        ...
                                        <form onSubmit={handleSubmit(onSubmit)}>
                                            <div className="p-6.5">
                                                <div className="mb-4.5">
                                                    ...
                                                    {errors.UserName && <p className="text-[#B45454] text-xs italic">{errors.UserName.message}</p>}
                                                </div>
                                                ...
                                                <div className="mb-4.5">
                                                    ...
                                                    {errors.Password && <p className="text-[#B45454] text-xs italic">{errors.Password.message}</p>}
                                                </div>
                                                ...
                                                <div className="mb-5.5">
                                                    ...
                                                    {errors.ConfirmPassword && <p className="text-[#B45454] text-xs italic">{errors.ConfirmPassword.message}</p>}
                                                </div>
