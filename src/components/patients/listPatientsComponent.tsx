    ...
    return (
        <>
            <div className="flex flex-col">
                ...
                {
                    Patients && Patients.filter(p => p.Status != StatusEnum.Cancel).map(patient => (
            ...
            </div>
            {
                ...
                <div x-show="popupOpen" className="fixed left-0 top-0 z-99999 flex h-screen w-full justify-center overflow-y-scroll bg-black/80 px-4 py-5"
                    ...
                    <div className="relative m-auto w-full max-w-180 rounded-sm border border-stroke bg-gray p-4 shadow-default dark:border-strokedark dark:bg-meta-4 sm:p-8 xl:p-10">
                        ...
                        <PatientsCreateComponent stateCreate={StatusEnum.Active} patientEdit={PatientEdit}
                            closeModal={() => setIsOpenDialogCreatedPatient(false)} ></PatientsCreateComponent>
                    </div>
                </div>
            }
        </>
